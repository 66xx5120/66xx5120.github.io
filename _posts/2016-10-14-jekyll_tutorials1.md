...
　如何使用 Jekyll 搭建博客，[博客模板效果](http://leopardpan.cn/#blog)。
...
> 解决：把CNAME里面的baixin.io修改成你自己的域名，如果你暂时没有域名，CNAME里面就什么都不用。（之前没人反馈过这个问题，应该是github page最近才最的限制。）


文章引用：http://leopardpan.cn/2016/10/jekyll_tutorials1(https://github.com/leopardpan/leopardpan.github.io/blob/master/_posts/2016-10-14-jekyll_tutorials1.md)
